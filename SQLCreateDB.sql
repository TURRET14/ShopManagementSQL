...
(ID INT PRIMARY KEY IDENTITY(0, 1),
OrderID INT REFERENCES SupplierOrders ON DELETE NO ACTION NOT NULL,
...
(ID INT PRIMARY KEY IDENTITY(0, 1),
OrderItemID INT REFERENCES SupplierOrderItems ON DELETE NO ACTION NOT NULL,
Amount INT NOT NULL CHECK (Amount >= 0) DEFAULT 0,
EmployeeID INT REFERENCES Employees ON DELETE SET NULL,
Reason VARCHAR(150),
Date DATETIMEOFFSET NOT NULL);
...
(ID INT PRIMARY KEY IDENTITY(0, 1),
OrderID INT REFERENCES CustomerOrders ON DELETE NO ACTION NOT NULL,
ProductID INT REFERENCES Products ON DELETE SET NULL,
Amount INT NOT NULL CHECK (Amount > 0) DEFAULT 1,
Price NUMERIC(10, 2) NOT NULL CHECK (Price >= 0) DEFAULT 0)
...
(ID INT PRIMARY KEY IDENTITY(0, 1),
OrderItemID INT REFERENCES CustomerOrderItems ON DELETE NO ACTION NOT NULL,
Amount INT NOT NULL CHECK (Amount >= 0) DEFAULT 0,
EmployeeID INT REFERENCES Employees ON DELETE SET NULL,
Reason VARCHAR(150),
Date DATETIMEOFFSET NOT NULL);